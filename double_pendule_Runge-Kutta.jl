...
function computeacceleration1(system::DoublePendule, omega_1::Float64, omega_2::Float64, theta_1::Float64, theta_2::Float64)
...
function computeacceleration2(system::DoublePendule, omega_1::Float64, omega_2::Float64, theta_1::Float64, theta_2::Float64)
...
function simulate(theta_1::Float64,theta_2::Float64,omega_1::Float64, omega_2::Float64, m1::Float64, m2::Float64, l1::Float64, l2::Float64, f1::Float64, f2::Float64, g::Float64, number_of_steps::Int, timestep::Float64)
...
function plotSystemComparaison(system::DoublePendule, time_iteration::Int, precision::Int, positions_x1_video::Vector{Float64}, positions_y1_video::Vector{Float64}, positions_x2_video::Vector{Float64}, positions_y2_video::Vector{Float64})
...
function plotSystemPositions(system::DoublePendule, precision::Int, positions_x1_video::Vector{Float64}, positions_y1_video::Vector{Float64}, positions_x2_video::Vector{Float64}, positions_y2_video::Vector{Float64})
...
function find_mass_factor(m_factor::Float64,angle1_video::Vector{Float64},angle2_video::Vector{Float64},angle1::Float64,angle2::Float64,l1::Float64,l2::Float64,f1::Float64,f2::Float64,g::Float64,timestep::Float64, number_of_steps::Int, number_of_frames::Int)
    ...
    system = simulate(angle1,angle2,0.0,0.0,m1,m2,l1,l2,f1,f2,g,number_of_steps,timestep)
...
function main(display_video::Bool, display_energie::Bool, find_parameters::Bool)
    ...
    plotSystemPositions(system, precision, positions_x1_video, positions_x2_video, positions_y1_video, positions_y2_video)
    ...
    if find_parameters
        ...
        for angle1 in range(3.13373, 3.20354; length=20)
            for angle2 in range(3.20228, 3.2721; length=20)
                ...
                push!(errors_2, errors[best_masse_idx])
                push!(angles1, angle1)
                push!(angles2, angle2)
            end
        end

        best_masse_idx = argmin(errors_2)
        println(errors_2[best_masse_idx])
        println(angles1[best_masse_idx])
        println(angles2[best_masse_idx])
    end
end
